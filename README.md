...
| --- | --- | --- | --- |
| Mobility and mechanical design | LEGO chassis, steering/drive mechanism, gear reasoning, dimensions, stability, iterations | [`models/Robot_Design.io`](./models/Robot_Design.io), [`v-photos/`](./v-photos/), [Mobility section](#mobility-and-mechanical-design) | Ready for presentation |
